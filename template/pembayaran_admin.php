        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Lish Siswa </h3>
            </div>
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div class="input-group icons">
                            <form action="search_siswa.php" method="get">
                                <table class="table">
                                <td>
                      ...
                      <table class="table">
                        ...
                        <?php
                          ...
                          while($data_siswa=mysqli_fetch_array($qry_siswa)){
                              ...
                              <td><a href="pay_admin.php?nisn=<?=$data_siswa['nisn']?>" class="badge badge-success">Pay</a>  
                              <a href="historypembayaran_admin.php?nisn=<?=$data_siswa['nisn']?>" class="badge badge-warning">History</a></td>
                              </tr>
                          <?php
                          }
                          ?>
