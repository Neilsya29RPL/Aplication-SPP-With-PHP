...
<html lang="en">
  ...
  <?php 
    include 'koneksi.php';
    session_start();
    $sql = 'select * from  siswa  join kelas on siswa.id_kelas=kelas.id_kelas where nisn =' .$_SESSION['nisn'];
                  ...
                  <div class="card-body">
                   <h4>History Pembayaran</h4>
                    ...
                    <div class="table-responsive">
                      ...
                      <a class='badge badge-info px-2' href='cetak_history.php?nisn=<?=$data['nisn']?>' target="_BLANK">Cetak</a> 
                    </div>
                  </div>
                </div>
              </div>
