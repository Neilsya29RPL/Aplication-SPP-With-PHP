                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <input type="hidden" name="nisn" value= "<?=$dt_siswa['nisn']?>">
                      ...
                      <button type="submit" name="simpan" value="Ubah Siswa" class="btn btn-primary mr-2">Submit</button>
                      <button class="btn btn-dark"><a href="tampil_siswa.php">Cancel</a></button>
                    </form>
                  </div>
                </div>
              </div>
