                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <input type="hidden" name="id_petugas" value= "<?=$dt_petugas['id_petugas']?>">
                      ...
                      <button type="submit" name="simpan" value="Ubah Petugas" class="btn btn-primary mr-2">Submit</button>
                      <button class="btn btn-dark"><a href="tampil_petugas.php">Cancel</a></button>
                    </form>
                  </div>
                </div>
              </div>
