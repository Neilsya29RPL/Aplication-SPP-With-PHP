                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <input type="hidden" name="id_kelas" value= "<?=$dt_kelas['id_kelas']?>">
                      ...
                      <button type="submit" name="simpan" value="Ubah Buku" class="btn btn-primary mr-2">Submit</button>
                      <button class="btn btn-dark"><a href="tampil_kelas.php">Cancel</a></button>
                    </form>
                  </div>
                </div>
              </div>
