    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <?php
                include "koneksi.php";
                $qry_get_pembayaran=mysqli_query($conn,"select * from pembayaran where id_pembayaran = '".$_GET['id_pembayaran']."'");
                $dt_pembayaran=mysqli_fetch_array($qry_get_pembayaran);
            ?>
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Edit Data Pembayaran </h3>
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <form action="proses_ubah_pembayaran.php" method="post">
                    <input type="hidden" name="id_pembayaran" value= "<?=$dt_pembayaran['id_pembayaran']?>">
                      <div class="form-group">
                        <label>NISN</label>
                        <input type="text" name="nisn" value= "<?=$dt_pembayaran['nisn']?>" class="form-control">
                      </div>
                      <div class="form-group">
                        <label>Tanggal Bayar</label>
                        <input type="date" name="tgl_bayar" value= "<?=$dt_pembayaran['tgl_bayar']?>" class="form-control">
                      </div>
                      <div class="form-group">
                        <label>Bulan</label>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="jumlah_bayar" value= "<?=$dt_pembayaran['jumlah_bayar']?>" class="form-control">
                      </div>
                      <button type="submit" name="simpan" value="Ubah pembayaran" class="btn btn-primary mr-2">Submit</button>
