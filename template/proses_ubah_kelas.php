<?php
    ...
    if($_POST){
        ...
        if(empty($nama_kelas)){
            ...
            $update=mysqli_query($conn,"update kelas set nama_kelas='".$nama_kelas."',kompetensi_keahlian='".$kompetensi_keahlian."',id_kelas='".$id_kelas."' where id_kelas= '".$id_kelas."'") or die(mysqli_error($conn));
            if($update){
